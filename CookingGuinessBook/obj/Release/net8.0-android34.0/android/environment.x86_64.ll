...
@dso_cache = dso_local local_unnamed_addr global [538 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 211207383386011443, ; hash 0x2ee5bff04a9b733, from name: aot-CookingGuinessBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CookingGuinessBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 5
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.86_name, ; name: libaot-mscorlib.dll.so
		ptr null; void* handle (0x0)
	}, ; 18
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.24_name, ; name: libaot-SQLitePCLRaw.nativelibrary.dll.so
		ptr null; void* handle (0x0)
	}, ; 56
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-SQLitePCLRaw.provider.dynamic_cdecl.dll.so
		ptr null; void* handle (0x0)
	}, ; 72
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4057273932309985397, ; hash 0x384e552523c9f875, from name: libaot-CookingGuinessBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CookingGuinessBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 122
	...
	%struct.DSOCacheEntry {
		i64 5535094051178400334, ; hash 0x4cd09ab69eddca4e, from name: CookingGuinessBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CookingGuinessBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 5943028764889346514, ; hash 0x5279e12c952871d2, from name: libaot-CookingGuinessBook.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CookingGuinessBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 8142926707612144732, ; hash 0x71017cb28f43545c, from name: CookingGuinessBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CookingGuinessBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 229
	...
	%struct.DSOCacheEntry {
		i64 15054867360283206338, ; hash 0xd0eda2199e4da2c2, from name: aot-CookingGuinessBook
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-CookingGuinessBook.dll.so
		ptr null; void* handle (0x0)
	}, ; 441
...
@.env.3 = private unnamed_addr constant [37 x i8] c"40c0c29c-9625-4d13-afae-24e2645a86a1\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [35 x i8] c"com.companyname.cookingguinessbook\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [33 x i8] c"libaot-CookingGuinessBook.dll.so\00", align 16
...
@.DSOCacheEntry.24_name = private unnamed_addr constant [41 x i8] c"libaot-SQLitePCLRaw.nativelibrary.dll.so\00", align 16
...
@.DSOCacheEntry.27_name = private unnamed_addr constant [50 x i8] c"libaot-SQLitePCLRaw.provider.dynamic_cdecl.dll.so\00", align 16
...
@.DSOCacheEntry.86_name = private unnamed_addr constant [23 x i8] c"libaot-mscorlib.dll.so\00", align 16
